"""
Django settings for staf_manag project.
...
CONGE_DECISION_LOCK_MINUTES = 15  # ex : 15 minutes de verrou après décision

# On va utiliser le CustomUser au lieu de User
